...
* An approach borrowed from CQRS allows for the efficient use of ORM for CRUD operations from “command” type use cases, while EntityFramewrok queries (defined in the specifications) are used with “query” type use cases requiring access to several related aggregates.
